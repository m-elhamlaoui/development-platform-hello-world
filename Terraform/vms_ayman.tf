resource "tls_private_key" "ssh_key_ayman" {
  algorithm = "RSA"
  rsa_bits  = 2048
}

resource "local_file" "private_key_ayman" {
  filename = "ssh_key_projet_hamlaoui_ayman"
  content  = tls_private_key.ssh_key_ayman.private_key_pem
}
...
resource "oci_core_instance" "aymanVM1" {
  availability_domain = data.oci_identity_availability_domains.ads.availability_domains[0].name
  compartment_id      = var.compartment_id
  display_name        = "aymanVM1"
...
# VM 2 - Ayman's second virtual machine
resource "oci_core_instance" "aymanVM2" {
  availability_domain = data.oci_identity_availability_domains.ads.availability_domains[0].name
  compartment_id      = var.compartment_id
  display_name        = "aymanVM2"
  shape               = "VM.Standard3.Flex"
